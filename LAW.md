...
| :-------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------- |
| **M1. Design System & Layout Doctrine** | Zero ad-hoc widgets or arbitrary dimensions outside `lib/design/`. NEVER use hardcoded `SizedBox(width: 20)` or `EdgeInsets.all(16)`.                                           | `lib/design/` (`Design.spacing.*`, `Design.icons.*`, `Design.timers.*`) |
| **M2. Theme-Aware Styling**             | ZERO hardcoded hex colors (`Color(0xFF...)`). Always access colors and styles through context extensions.                                                                       | `context.colors.primary`, `context.colors.surface`, `context.typo.*`    |
